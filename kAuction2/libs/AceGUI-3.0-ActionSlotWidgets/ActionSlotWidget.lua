...
local options = {
	...
	set = function(info, value)
		db[info[#info]] = value
		print('Set', addonName, info[#info], value)
	end,
	args = {
		any = {
			name = 'Any',
		...
		disableable = {
			...
			type = 'input',
			control = 'ActionSlot',
			disabled = function() return db.disableIt end,
			order = 20,
		},
		disableIt = {
			name = 'Disable Disableable',
			type = 'toggle',
			order = 30,
		},
		Validated = {
			...
			validate = function(info, value)
				return value:match('item:') and true
			end,
			order = 30,
		},
		item = {
			name = 'Item',
			type = 'input',
			control = 'ActionSlotItem',
			order = 40,
		},
		spell = {
			name = 'Spell',
			type = 'input',
			control = 'ActionSlotSpell',
			order = 40,
		},
		macro = {
			name = 'Macro',
			type = 'input',
			control = 'ActionSlotMacro',
			order = 50,
		},
		equipmentset = {
			name = 'Equipmentset',
			type = 'input',
			control = 'ActionSlotEquipmentSet',
			order = 60,
		},
		nolabel = {
			name = '',
...
SLASH_FOO1 = "/foo"
function SlashCmdList.FOO() InterfaceOptionsFrame_OpenToCategory(panel) end
--@end-debug@]===]
